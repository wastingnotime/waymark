...
_GRAPH_TARGET_BY_OBSERVATION = {
    "account_created": "event_stream",
    "duplicate_account_creation_ignored": "event_stream",
    "subscription_requested": "event_stream",
    "duplicate_subscription_request_ignored": "event_stream",
    "payment_succeeded": "event_stream",
    "payment_failed": "event_stream",
    "payment_recovered": "event_stream",
    "duplicate_payment_success_ignored": "event_stream",
    "duplicate_payment_failure_ignored": "event_stream",
    ...
    "note_recorded": "event_stream",
    "log_entry_recorded": "event_stream",
    "note_rejected": "access_control",
    "log_entry_rejected": "access_control",
    "daily_entry_summary": "summary",
    "account_inspected": "access_control",
    "cancellation_scheduled": "event_stream",
    "duplicate_cancellation_ignored": "event_stream",
}
...
def create_simulation() -> Scenario:
    ...
    return Scenario(
        ...
        observatory_nodes=[
            ...
            ObservatoryNode("event_stream", "Waymark Event Stream", "event", "domain_events", realm="waymark", domain="Shared", status="active"),
        ...
        observatory_edges=[
            ...
            ObservatoryEdge("account_bootstrap", "event_stream", "publishes account event", kind="route"),
            ObservatoryEdge("subscriber", "subscription_lifecycle", "requests subscription", kind="route"),
            ObservatoryEdge("subscription_lifecycle", "event_stream", "publishes subscription event", kind="route"),
            ...
            ObservatoryEdge("payment_processing", "event_stream", "publishes payment event", kind="route"),
            ...
            ObservatoryEdge("recording", "event_stream", "publishes entry event", kind="route"),
            ObservatoryEdge("event_stream", "fact_history", "persists domain event", kind="route"),
            ...
            ObservatoryEdge("entitlement", "event_stream", "publishes lifecycle event", kind="route"),
        ],
    )
